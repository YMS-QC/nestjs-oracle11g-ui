  ...
  <div class="w-xs">
    ...
    <template v-if="activeName === 'message'">
      <OverlayScrollbarsComponent :options="{ scrollbars: { autoHide: 'leave', autoHideDelay: 300 } }" defer class="list max-h-300px">
        ...
        <div class="item">
          <SvgIcon name="ri:service-fill" class="service" />
          <div class="info">
            <div class="title">
        ...
        <div class="item">
          <SvgIcon name="ri:file-edit-fill" class="file-edit" />
          <div class="info">
            <div class="title">
              你有 3 份合同待审批
            </div>
    ...
    <template v-if="activeName === 'todo'">
      <OverlayScrollbarsComponent :options="{ scrollbars: { autoHide: 'leave', autoHideDelay: 300 } }" defer class="list max-h-300px">
        <div class="flex flex-col items-center py-6 text-stone-5">
          <SvgIcon name="tabler:mood-smile" :size="40" />
          <p m-2 text-base>
            没有新待办
          </p>
        </div>
